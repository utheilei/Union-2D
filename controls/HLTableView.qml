...
TableView {
    ...
    itemDelegate: Rectangle {
        ...
        height: 36
        radius: 10
        color: styleData.selected ? sPalette.highlight : sPalette.button
        ...
        Text {
            ...
            color: styleData.selected ? sPalette.highlightedText : sPalette.windowText
            horizontalAlignment: Text.AlignHCenter
            verticalAlignment: Text.AlignVCenter
        }
    }
